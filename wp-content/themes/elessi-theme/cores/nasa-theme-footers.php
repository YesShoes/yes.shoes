...
if (!function_exists('elessi_link_style_off_canvas')) :
    function elessi_link_style_off_canvas() {
        ...
        echo !isset($nasa_opt['css_canvas']) || $nasa_opt['css_canvas'] == 'async' ? '<script type="text/template" id="nasa-style-off-canvas"><link rel="stylesheet" id="nasa-style-off-canvas-css" href="' . esc_url(ELESSI_THEME_URI . '/assets/css/style-off-canvas.css') . '" /></script>' : '';
    }
endif;
