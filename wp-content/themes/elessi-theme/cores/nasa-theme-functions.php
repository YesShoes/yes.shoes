    ...
    function elessi_multi_languages() {
        ...
        if (isset($nasa_opt['switch_lang']) && $nasa_opt['switch_lang']) {
             ...
             */
                 ...
                 */
                // Deutsch
                $selectLang .= '<li class="nasa-item-lang"><a href="#" title="Deutsch">';
                ...
                // Français
                $selectLang .= '<li class="nasa-item-lang"><a href="#" title="Français">';
                ...
                // Requires WPML
                $selectLang .= '<li class="nasa-item-lang"><a href="#" title="Requires WPML">';
