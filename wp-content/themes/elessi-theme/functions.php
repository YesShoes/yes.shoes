...
function njengah_custom_checkout_field_process() {
	...
	if ( ! ( preg_match( '/^\+38-[0]{1}(67|96|97|98|50|66|95|99|63|73|93)-[0-9]{7}$/', $_POST['billing_phone'] ) ) ) {
		wc_add_notice( "Невірний номер, введіть в форматі +38-000-0000000", 'error' );
	}

}
defined('NASA_VERSION') or define('NASA_VERSION', '4.9.6');
