...
class XFGMC_Get_Unit_Offer_Simple extends XFGMC_Get_Unit_Offer {
	...
	public function generation_product_xml() {
		...
		$result_xml .= $this->get_identifier_exists();
		...
		$result_xml = apply_filters('xfgmc_append_simple_offer_filter', $result_xml, $this->get_product(), $result_url, $this->get_feed_id()); /* с версии 2.2.1 добавлены $result_url, $this->get_feed_id() */	   
