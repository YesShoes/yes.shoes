...
*/
		...
		$result_xml = apply_filters('xfgmc_append_variable_offer_filter', $result_xml, $this->product, $this->offer, $result_url, $this->feed_id); /* с версии 2.2.1 добавлен $result_url */
